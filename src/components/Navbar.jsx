        ...
        <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
            ...
            <ul className={!navbarState ? 'hidden' : 'absolute top-0  left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center md:hidden'}>
                <li className='py-6 text-4xl'>
                    <Link onClick={handleOnToggleNavBarCallback} to="home" spy={true} smooth={true} duration={500} >
                        Home
                    </Link>
                </li>
                <li className='py-6 text-4xl'>
                    <li>
                        <Link onClick={handleOnToggleNavBarCallback} to="about" spy={true} smooth={true} duration={500}>
                            About
                        </Link>
                    </li>
                </li>
                <li className='py-6 text-4xl'>
                    <li>
                        <Link onClick={handleOnToggleNavBarCallback} to="skills" spy={true} smooth={true} duration={500}>
                            Skills
                        </Link>
                    </li>
                </li>
                <li className='py-6 text-4xl'>
                    <li>
                        <Link onClick={handleOnToggleNavBarCallback} to="work" spy={true} smooth={true} duration={500}>
                            Work
                        </Link>
                    </li>
                </li>
                <li className='py-6 text-4xl'>
                    <Link onClick={handleOnToggleNavBarCallback} to="contact" spy={true} smooth={true} duration={500}>
                        Contact
                    </Link>
                </li>
            </ul>
